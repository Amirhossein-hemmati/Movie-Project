...
<template>
  <div class="flex justify-center items-center">
    <!-- "For cleaner code and potential future development, I separated the layout component, but it can also be imported directly in the App if needed." -->
    <DefaultLayout v-if="online" />
    <div
      v-else
      class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-y-2"
    >
      <span>
        <svg
      ...
      <span> لطفا شبکه خود را بررسی کنید </span>
    </div>
  </div>
</template>
